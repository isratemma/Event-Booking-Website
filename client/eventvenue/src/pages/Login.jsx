    ...
    >
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold mt-4" style={{ color: '#1E1B4B' }}>Welcome back</h2>
        ...
        {/* Demo credentials */}
        <div className="mt-5 p-4 rounded-xl text-xs text-gray-500 space-y-1" style={{ backgroundColor: '#F5F3FF' }}>
          <p className="font-bold text-gray-600 mb-1">Demo Credentials</p>
          <p>👤 Admin: <span className="font-medium">admin@eventvenue.com</span> / password123</p>
          <p>👤 User: <span className="font-medium">emma@example.com</span> / password123</p>
        </div>

        <p className="text-center text-sm text-gray-400 mt-6">
          Don't have an account?{' '}
          <Link to="/register" className="font-bold hover:underline" style={{ color: '#7C3AED' }}>
            Sign up
          </Link>
        </p>
